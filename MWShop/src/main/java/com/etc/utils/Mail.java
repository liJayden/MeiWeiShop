...
public class Mail {
	...
	public static void sendMail(String to,String code){
		...
		try {
			...
			// 设置邮件正文:
			message.setContent("<h2 align='center'>来自美唯电器城官方激活邮件!请点击链接完成激活操作!</h2><h1 align='center'><a href='http://meiwei.ngrok.cc/MWShop/MWController/active?code="+code+"'>ヾ(@^▽^@)ノ   点击激活	ヽ(ﾟ∀ﾟ)ﾒ(ﾟ∀ﾟ)ﾉ  </a></h1>", "text/html;charset=UTF-8");
			// 3.发送邮件:
