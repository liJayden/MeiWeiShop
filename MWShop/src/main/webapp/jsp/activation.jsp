				...
				<tr>
					<td width="67%" rowspan="5">
						<div class="login-focus fr" style="border-right: 1px dotted #ccc">
							<img src="${pageContext.request.contextPath}/img/login/mewe2.PNG"	width="450" height="295" />
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div >
							...
							&nbsp;&nbsp; | &nbsp;&nbsp;
							<a href="${pageContext.request.contextPath}/jsp/login.jsp">去登陆</a>
							&nbsp;&nbsp; | &nbsp;&nbsp;
							<a href="${pageContext.request.contextPath}/jsp/register.jsp">去注册</a>
						</div>
					</td>
				</tr>
