	...
	<section class="rt_wrap content mCustomScrollbar">
		<div class="rt_content">
			...
			<section>
				...
				<form
					action="${pageContext.request.contextPath}/AControllerSecond/addCategroySecond" method="post">
					<ul class="ulColumn2">
					<li><span class="item_name" style="width: 120px;">分类:</span>
						...
						<li><span class="item_name" style="width: 120px;">名称：</span>
							<input type="text" class="textbox" placeholder="输入二级分类名称"name="csname" /></li>
						<li><span class="item_name" style="width: 120px;"></span> <input type="submit" class="link_btn" value="添加" /></li>
					</ul>
				</form>
			</section>
		</div>
