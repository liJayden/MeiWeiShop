...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">商品详情</h2>
       <a class="fr top_rt_btn" href="${pageContext.request.contextPath}/jsp/aproduct_list.jsp">返回产品列表</a>
      </div>
     <section>
      <ul class="ulColumn2">
       <li>
       ...
       <li>
        <span class="item_name" style="width:120px;">热销价格：</span>
        <input type="text" class="textbox" placeholder="商品货号..."/>
       </li>
...
<script src="${pageContext.request.contextPath}/ajs/ueditor.all.min.js"> </script>
